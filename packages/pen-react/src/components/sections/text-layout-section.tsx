...
export function TextLayoutSection({ node, onUpdate }: TextLayoutSectionProps) {
  ...
  return (
    <div className="space-y-1.5">
      <SectionHeader title="Text Layout" />

      <div>
        <span className="text-[10px] text-muted-foreground mb-1 block">Dimensions</span>
      ...
      <div>
        <span className="text-[10px] text-muted-foreground mb-1 block">Resizing</span>
